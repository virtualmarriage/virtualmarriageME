      ...
      return Row(
        children: <Widget>[
              ...
              child: Material(
                child: CachedNetworkImage(
                  ...
                  errorWidget: (context, url, error) => Material(
                    child: Image.asset(
                      'assets/chatimages/img_not_available.jpeg',
                      width: 200.0,
                      height: 200.0,
                      fit: BoxFit.cover,
                    ),
          ...
          // Sticker
              : Container(
            child: Image.asset(
              'assets/chatimages/${document.data()['content']}.gif',
              width: 100.0,
              height: 100.0,
              fit: BoxFit.cover,
            ),
